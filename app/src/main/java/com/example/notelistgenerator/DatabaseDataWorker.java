...
public class DatabaseDataWorker {
    ...
    private void insertCourse(String courseId, String title) {
        ...
        values.put(NoteKeeperDatabaseContract.CourseEntry.COLUMNS_COURSE_ID, courseId);
        values.put(NoteKeeperDatabaseContract.CourseEntry.COLUMNS_COURSE_TITLE, title);

        long newRowId = mDb.insert(NoteKeeperDatabaseContract.CourseEntry.TABLE_NAME, null, values);
    }
     ...
     private void insertNote(String courseId, String title, String text) {
        ...
        values.put(NoteKeeperDatabaseContract.NoteInfoEntry.COLUMNS_NOTE_TITLE, title);
        values.put(NoteKeeperDatabaseContract.NoteInfoEntry.COLUMNS_NOTE_TEXT, text);
